...
Как только обучу resnet101 с Adabound здесь будет вывод о том, какой оптимизатор в данной задаче был эффективнее. Предварительно кажется, что в моем случае AdaBound медленне обучает модель, но меньше переобучается в данной ситуации.

Нудно учитывать, что моя имплементация resnet101 отличается от официальной и даже если бы не отличалась, нужно одинаково инициализировать веса для справедливости.
