...
Исползование реализации свертки в виде матричного умножения делает прямое и обратное распространение сопоставимыми по времени с torch (продемонстрировано в конце [./numpy_CNN/module_tests.ipynb](./numpy_CNN/module_tests.ipynb))

Так как основное различие моей имплементации pytorch и официальной имплементации - отсутствие батч-нормализации, можно сделать вывод о важности батч-нормализации для скорости обучения.
