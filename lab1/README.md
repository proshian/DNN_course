...
В файле ./numpy_CNN/numpy_resnet.py реализация ResNet и resnet-101 на numpy.

В директории ./numpy_CNN/NumpyNN находится python модуль NN_np, в котором реализованы модули нейронной сети.
